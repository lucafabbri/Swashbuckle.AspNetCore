...
using Higrow.AspNetCore.Swagger;
...
namespace Higrow.AspNetCore.SwaggerGen.Test
{
    public class SwaggerGeneratorTests
    {
        ...
        public void GetSwagger_ThrowsSwaggerGeneratorException_IfActionHasNoHttpBinding()
        {
            ...
            Assert.Equal(
                "Ambiguous HTTP method for action - Higrow.AspNetCore.SwaggerGen.Test.FakeController.ActionWithNoParameters (Higrow.AspNetCore.SwaggerGen.Test). " +
        ...
        public void GetSwagger_ThrowsSwaggerGeneratorException_IfActionsHaveConflictingHttpMethodAndPath()
        {
            ...
            Assert.Equal(
                ...
                "Higrow.AspNetCore.SwaggerGen.Test.FakeController.ActionWithNoParameters (Higrow.AspNetCore.SwaggerGen.Test)," +
                "Higrow.AspNetCore.SwaggerGen.Test.FakeController.ActionWithNoParameters (Higrow.AspNetCore.SwaggerGen.Test). " +
