...
namespace Higrow.AspNetCore.Newtonsoft.Test
{
    public class NewtonsoftSchemaGeneratorTests
    {
        ...
        public void GenerateSchema_SupportsOption_SchemaIdSelector()
        {
            ...
            Assert.Equal("Higrow.AspNetCore.TestSupport.ComplexType", referenceSchema.Reference.Id);
        ...
        [InlineData(TypeNameHandling.Objects, TypeNameAssemblyFormatHandling.Full, true,
            "Higrow.AspNetCore.TestSupport.{0}, Higrow.AspNetCore.TestSupport, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null")]
        ...
        [InlineData(TypeNameHandling.Auto, TypeNameAssemblyFormatHandling.Simple, true,
            "Higrow.AspNetCore.TestSupport.{0}, Higrow.AspNetCore.TestSupport")]
