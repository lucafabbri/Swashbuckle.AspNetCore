...
namespace Microsoft.Extensions.DependencyInjection
{
    public static class SwaggerGenOptionsExtensions
    {
        ...
        /// <summary>
        /// To support polymorphism and inheritance behavior, Higrow needs to detect the "known" subtypes for a given base type.
        ...
        /// and UseOneOfForPolymorphism is enabled, then Higrow will include a description for that property based on the serializer's behavior.
        /// However, if you've customized your serializer to support polymorphism, you can provide a custom strategy to tell Higrow which property,
        ...
        /// <summary>
        /// If the configured serializer supports polymorphic serialization/deserialization by emitting/accepting a special "discriminator" property,
        /// and UseOneOfForPolymorphism is enabled, then Higrow will include a mapping of possible discriminator values to schema definitions.
        /// However, if you've customized your serializer to support polymorphism, you can provide a custom mapping strategy to tell Higrow what
